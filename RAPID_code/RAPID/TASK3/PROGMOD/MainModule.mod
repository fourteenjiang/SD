MODULE MainModule
    ...
    PERS num shake;
    VAR string rec_json;! shoul1 means connected 
    VAR bool con_rec;
        ...
        WHILE client_connected = TRUE DO
          ...
          weight_vial_reday:=FALSE;
            ...
            ENDIF
                ...
                IF command{3}=100 or command{2}=1000 or command{4}=1000THEN  ! the value can be changed just for noting the receieve data no stable
